...
using MauiApp.NotificationService.Services;
...
// Register services
builder.Services.AddScoped<INotificationService, MauiApp.NotificationService.Services.NotificationService>();
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        ...
        Version = "v1",
        Description = "API for push notifications, email notifications, and in-app notifications"
    });
