...
using MauiApp.SyncService.Services;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    { 
        ...
        Version = "v1",
        Description = "API for offline synchronization, conflict resolution, and delta updates"
    });
...
// Background services for sync processing
builder.Services.AddHostedService<SyncProcessingService>();
